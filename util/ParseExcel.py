...
class ParseExcel(object):
    ...
    def __init__(self):
        self.workbook = None
        self.excelFile = None
        self.font =Font(cole = None) # 设置字体的颜色
        # 颜色对应的 RGB值
    ...
    def getSheetByIndex(self, sheetIndex):
        ...
        try:
            sheet = self.workbook.get_sheet_by_name()[sheetIndex]
        except Exception as e:
            raise e
        sheet = self.workbook.get_sheet_by_name(sheetname)
        return sheet
    ...
    def writeCellCurrentTime(self, sheet, coordinate = None,rowNo=None,colsNo = None):
        ...
        if coordinate is not None:
            try:
                ...
                raise e
        elif coordiate == None and rowNo is not None and colsNo is not None:
            try:
...
if __name__ == '__mail__':
    ...
    pe.loadWorkBook(u"D:\\DataDrivenFrameWork\\day2_312_327\\testData\\126邮箱联系人.xlsx")
